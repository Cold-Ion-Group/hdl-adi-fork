...
| TIM‑2 | Agility latency (freq/phase/amp hop) | Insert marker (time‑domain) and command update; capture time‑to‑settle and any transients | MUST: report p50/p95/p99/max latency; “pass” = meets your chosen experiment‑class bound | `latency_stats.csv`, waveforms |

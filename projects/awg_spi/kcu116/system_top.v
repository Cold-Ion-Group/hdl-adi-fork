...
//  input                  spi_miso,
 ...
 // output                  spi_mosi,   
   output                  spi_dir,
  inout       [4:0]       dac_ctrl //FMC_HPC0_LA07_P 
  //inout       [2:0]       dac_ctrl_n // FMC_HPC0_LA07_N
);
...
//assign iic_rstn = 1'b1;
  ...
  // spi enable is active high for AD9144 
...
// for ad9144 the third bit needs no connection 
  // default logic
// no fan control 
  //assign fan_pwm = 1'b1;
...
// awg spi is not required, may be required later on 

...
proc adi_tpl_jesd204_tx_create {ip_name num_of_lanes num_of_converters samples_per_frame sample_width {link_layer_bytes_per_beat 4} {dma_sample_width 16}} {
  ...
  set result [catch {
    ...
    create_bd_pin -dir I -from [expr $num_of_converters * 32 - 1] -to 0 "${ip_name}/sched_init_s"
    create_bd_pin -dir I -from [expr $num_of_converters * 32 - 1] -to 0 "${ip_name}/sched_incr_s"
